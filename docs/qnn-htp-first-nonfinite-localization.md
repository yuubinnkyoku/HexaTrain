...
The L19 depth observation was corrected: seed 1 was finite 3/3, while seed 2 reproduced a final-evaluation `layer_018_output` nonfinite 3/3. It was outside the frozen completion scope and remains unresolved. The FFN372 five-seed formal was interrupted by an ADB endpoint change and is reported as harness-incomplete, not a numerical failure. L2/H2 and L6/H8 seed-1 320-step regressions passed finite with zero nonzero QNN returns.
