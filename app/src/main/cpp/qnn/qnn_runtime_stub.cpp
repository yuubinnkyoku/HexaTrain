...
bool Runtime::prepareTinyTransformerTraining(uint32_t,uint32_t,uint32_t,float,bool,std::string&e,uint32_t,TinyTransformerTrainingVariant){e="QNN_DISABLED: tiny transformer training unavailable";return false;}
