...
struct Timings {
  ...
  double unpackCandidateParameterCopyUs = 0.0;
  double unpackCandidateMomentumCopyUs = 0.0;
  ...
  double auxParameterCopyUs = 0.0;
  double auxMuonMomentumCopyUs = 0.0;
  double auxAdamMCopyUs = 0.0;
  double auxAdamVCopyUs = 0.0;
  double auxRegistryConstructionUs = 0.0;
  double auxRegistryValidationUs = 0.0;
  double auxPreUpdateFiniteValidationUs = 0.0;
  double auxPreParameterFiniteValidationUs = 0.0;
  double auxPreGradientFiniteValidationUs = 0.0;
  double auxPreMomentumFiniteValidationUs = 0.0;
  double auxPreAdamMFiniteValidationUs = 0.0;
  double auxPreAdamVFiniteValidationUs = 0.0;
  double auxArithmeticUs = 0.0;
  double auxPostUpdateFiniteValidationUs = 0.0;
